            ...
            <ul class="nav metismenu" id="side-menu">
                <li class="active">
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li class="active"><a href="dashboard_5.html">Dashboard v.5 <span
                ...
                <li>
                    <a href="dashboard_5.html#"><i class="fa fa-bar-chart-o"></i> <span
                ...
                <li>
                    <a href="dashboard_5.html#"><i class="fa fa-edit"></i> <span class="nav-label">Forms</span><span
                            class="fa arrow"></span></a>
                    <ul class="nav nav-second-level collapse">
                ...
                <li>
                    <a href="dashboard_5.html#"><i class="fa fa-desktop"></i> <span
                ...
                <li>
                    <a href="dashboard_5.html#"><i class="fa fa-files-o"></i> <span
                ...
                <li>
                    <a href="dashboard_5.html#"><i class="fa fa-globe"></i> <span
                            class="nav-label">Miscellaneous</span><span class="label label-info pull-right">NEW</span>
                    </a>
                    <ul class="nav nav-second-level collapse">
                ...
                <li>
                    <a href="dashboard_5.html#"><i class="fa fa-flask"></i> <span
                            class="nav-label">UI Elements</span><span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level collapse">
                        <li><a href="typography.html">Typography</a></li>
                        <li><a href="icons.html">Icons</a></li>
                        <li><a href="draggable_panels.html">Draggable Panels</a></li> <li><a
                            href="resizeable_panels.html">Resizeable Panels</a></li>
                ...
                <li>
                    <a href="grid_options.html"><i class="fa fa-laptop"></i> <span class="nav-label">Grid options</span>
                    </a>
                </li>
                <li>
                    <a href="dashboard_5.html#"><i class="fa fa-table"></i> <span class="nav-label">Tables</span><span
                            class="fa arrow"></span></a>
                    <ul class="nav nav-second-level collapse">
                ...
                <li>
                    <a href="dashboard_5.html#"><i class="fa fa-shopping-cart"></i> <span
                ...
                <li>
                    <a href="dashboard_5.html#"><i class="fa fa-picture-o"></i> <span
                ...
                <li>
                    <a href="dashboard_5.html#"><i class="fa fa-sitemap"></i> <span
                            class="nav-label">Menu Levels</span><span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level collapse">
                        <li>
                            <a href="dashboard_5.html#">Third Level <span class="fa arrow"></span></a>
                            <ul class="nav nav-third-level">
                                <li>
                                    <a href="dashboard_5.html#">Third Level Item</a>
                                </li>
                                <li>
                                    <a href="dashboard_5.html#">Third Level Item</a>
                                </li>
                        ...
                        <li><a href="dashboard_5.html#">Second Level Item</a></li>
                        <li>
                            <a href="dashboard_5.html#">Second Level Item</a></li>
                        <li>
                            <a href="dashboard_5.html#">Second Level Item</a></li>
                    </ul>
                </li>
